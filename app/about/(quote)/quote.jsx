...
export default function Quote() {
  const text1 =
    '"Seseorang yang putus asa melihat kesulitan dalam setiap kesempatan,'.split(
      " "
    );
  const text2 =
    'tetapi orang yang optimis melihat peluang dalam setiap kesulitan." - Ali Bin Abi Thalib'.split(
      " "
    );
