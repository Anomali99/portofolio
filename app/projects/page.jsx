...
// images
import Weton1 from "@/public/projects/weton-web/weton1.png";
import Weton2 from "@/public/projects/weton-web/weton2.png";
import Weton3 from "@/public/projects/weton-web/weton3.png";
  ...
  return (
    <>
      <main className="overflow-hidden">
        ...
        <div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
          ...
          <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-gray-100 bg-opacity-50 md:bg-transparent md:pt-0">
            ...
            <p className="title  text-xl mt-4 tracking-wider text-gray-900 leading-[1.7rem] mb-5">
              Beberapa project yang penah saya kembangkan.
            </p>
            <motion.div
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Weton Web adalah salah satu aplikasi web yang saya kembangkan
              menggunakan Vue.js dan Tailwind CSS, dirancang dengan antarmuka
              yang sederhana dan responsif untuk memberikan pengalaman pengguna
              yang nyaman dan mudah. Aplikasi ini bertujuan untuk menghitung sio
              atau weton seseorang berdasarkan perhitungan Jawa, sehingga
              pengguna dapat memperoleh informasi mengenai karakteristik dari
              hari lahir mereka sesuai dengan tradisi Jawa.
            </p>{" "}
            <div className="mt-3">
              <Button variation="primary">
                <Link href="projects/weton-web">More</Link>
              </Button>
              <Button variation="secondary">
                <a
                  href="https://weton-next.web.app/"
                  target="_blank"
        ...
        {/* projects */}
        <div className="w-screen mt-4 mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10 cursor-pointer">
